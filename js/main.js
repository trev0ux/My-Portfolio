...
$(window).ready(function() {
 ...
 function redirectCasaTorre() {
     window.location.href = "https://www.casatorre.surge.sh"
 }

 function redirectJonad() {
    window.location.href = "https://www.jonad.surge.sh"
 }

 function redirectBookmark() {
    window.location.href = "https://github.com/trev0ux/Landing-Page"
 }
